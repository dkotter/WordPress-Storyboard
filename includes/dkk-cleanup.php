...
function roots_excerpt_more($more) {
	return ' &hellip; <a href="' . get_permalink() . '">' . __( 'Continued', 'storyboard' ) . '</a>';
}
...
function roots_notice_tagline() {
	...
	echo '<p>', sprintf(__('Please update your <a href="%s">site tagline</a>', 'storyboard'), admin_url('options-general.php')), '</p>';
	echo '</div>';
}
